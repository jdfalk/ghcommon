...
ECOSYSTEM_DETECTORS = {
    ...
    "devcontainers": [
        ...
        ".devcontainers/devcontainer.yml",
    ],
                ...
                if search_dir.exists():
                    ...
                    if ecosystem == "github-actions":
                        ...
                        if (
                            ...
                            and any(workflows_dir.glob("*.yml"))
                            or any(workflows_dir.glob("*.yaml"))
                        ):
...
def build_ecosystem_entries(ecosystems: list[str]) -> str:
    ...
    for ecosystem in ecosystems:
        ...
        # Determine directory
        directory = "/"
        if ecosystem == "pip" and "scripts" in str(Path.cwd()):
            directory = "/scripts"
...
def build_dependabot_config(ecosystems: list[str]) -> str:
    ...
    config = f"""# Dependabot Configuration
...
def main():
    ...
    results_file = Path("/tmp/dependabot_update_results.json")
