...
```yaml
  publish-python-sdk:
    ...
    environment:
      name: pypi
      url: https://pypi.org/project/${{ github.repository_owner }}-${{ github.event.repository.name }}-proto
...
```yaml
  publish-typescript-sdk:
    ...
    environment:
      name: npm
      url: https://www.npmjs.com/package/@${{ github.repository_owner }}/${{ github.event.repository.name }}-proto
...
```yaml
  publish-rust-sdk:
    ...
    environment:
      name: crates-io
      url: https://crates.io/crates/${{ github.repository_owner }}-${{ github.event.repository.name }}-proto
