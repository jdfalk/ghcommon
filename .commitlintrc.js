  ...
  plugins: [
    {
      rules: {
        'files-changed-section': (parsed) => {
          ...
          if (!body) {
            return [false, 'Commit body should include a "Files changed:" section listing all modified files'];
          }

          // Check if "Files changed:" section exists
          if (!body.includes('Files changed:')) {
            return [false, 'Commit body must include a "Files changed:" section listing all modified files'];
          }
